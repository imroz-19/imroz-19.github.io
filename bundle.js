...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _filterJobs = __webpack_require__(53);

	var _TaskLayout = __webpack_require__(54);

	var _TaskLayout2 = _interopRequireDefault(_TaskLayout);

	var _TaskModal = __webpack_require__(55);

	var _TaskModal2 = _interopRequireDefault(_TaskModal);

	var _TableContent = __webpack_require__(56);

	var _TableContent2 = _interopRequireDefault(_TableContent);

	var _TaskGrid = __webpack_require__(58);

	var _TaskGrid2 = _interopRequireDefault(_TaskGrid);
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    _this.handleClick = function (column, row) {
	      var _this$state$jobDetail = _this.state.jobDetails,
	          jobDetails = _this$state$jobDetail === undefined ? {} : _this$state$jobDetail;

	      var selectedKey = Object.keys(jobDetails)[column];
	      var itemsToBeShownInModal = { list: jobDetails[selectedKey], date: selectedKey };
	      console.log('itemsToShowInModal', itemsToBeShownInModal);
	      _this.setState({
	        showModal: true,
	        itemsToBeShownInModal: _extends({}, itemsToBeShownInModal),
	        selectedIndex: {
	          row: row,
	          column: column
	        }
	    ...
	    _this.handleItemClickOnModal = function (name, jobname, date, index) {
	      var _this$state$jobDetail2 = _this.state.jobDetails,
	          jobDetails = _this$state$jobDetail2 === undefined ? {} : _this$state$jobDetail2;

	      var res = [];
	      for (var i = 0; i < jobDetails[date].length; i++) {
	        if (index !== i) {
	          res.push(jobDetails[date][i]);
	        }
	      }
	      var _this$state$selectedI = _this.state.selectedIndex,
	          row = _this$state$selectedI.row,
	          column = _this$state$selectedI.column;

	      _this.setState({
	        taskInfoFromModal: [].concat(_toConsumableArray(_this.state.taskInfoFromModal), [{ rowIndex: row, columnIndex: column, task: { name: name, jobname: jobname } }]),
	        showModal: false,
	        jobDetails: _extends({}, jobDetails, _defineProperty({}, date, res))
	      });
	    };
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var getJobDetails = _axios2.default.get('../data/getWorkOrderList.json');
	      var getEmployees = _axios2.default.get('../data/getEmployeeList.json');
	      _axios2.default.all([getJobDetails, getEmployees]).then(_axios2.default.spread(function () {
	        for (var _len = arguments.length, responses = Array(_len), _key = 0; _key < _len; _key++) {
	          responses[_key] = arguments[_key];
	        }

	        var jobDetails = (0, _filterJobs.filterJobByDate)(responses[0].data);
	        var employees = responses[1].data.employees || [];
	        _this2.setState({
	    ...
	    value: function render() {
	      var _state = this.state,
	          jobDetails = _state.jobDetails,
	          itemsToBeShownInModal = _state.itemsToBeShownInModal,
	          showModal = _state.showModal,
	          taskInfoFromModal = _state.taskInfoFromModal,
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'tr',
	                null,
	                _react2.default.createElement('th', { className: 'borderBottom' }),
	                _react2.default.createElement(_Header2.default, { jobDetails: jobDetails })
	              ),
	              ...
	              _react2.default.createElement(_TaskGrid2.default, { jobDetails: jobDetails })
	            )
	          ),
	          showModal ? _react2.default.createElement(_TaskModal2.default, {
...
/***/ (function(module, exports) {
	...
	var filterJobByDate = exports.filterJobByDate = function filterJobByDate(_ref) {
	    var job = _ref.job;

	    var resultantDateMap = {};
	    ...
	    try {
	        var _loop = function _loop() {
	            var jobItem = _step.value;
	            var jobname = jobItem.jobname,
	                _jobItem$workorders = jobItem.workorders,
	                workorders = _jobItem$workorders === undefined ? {} : _jobItem$workorders;
	            // iterate over all workorders

	            workorders.forEach(function (workorder) {
	                var date = new Date(workorder.Date);
	        ...
	        for (var _iterator = job[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            _loop();
	        }
	    } catch (err) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TaskLayout = function TaskLayout(_ref) {
	  var name = _ref.name,
	      jobname = _ref.jobname,
	      date = _ref.date,
	      index = _ref.index,
	      isModal = _ref.isModal,
	      handleItemClickOnModal = _ref.handleItemClickOnModal;

	  var _onClick = isModal ? handleItemClickOnModal : function () {
	    return true;
	  };
	  return _react2.default.createElement(
	    "div",
	    { className: "task-box", onClick: function onClick() {
	        return _onClick(name, jobname, date, index);
	      } },
	    _react2.default.createElement(
	      "div",
	      { className: "task-name" },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TaskModal = function TaskModal(_ref) {
	    ...
	    return Object.keys(items).length > 0 ? _react2.default.createElement(
	        'div',
	        { className: 'modal-wrapper' },
	        _react2.default.createElement(
	            'div',
	            { className: 'modal-content' },
	            items.list.map(function (_ref2, index) {
	                var name = _ref2.name,
	                    jobname = _ref2.jobname;

	                return _react2.default.createElement(_TaskLayout2.default, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getGridContent = function getGridContent(taskInfoFromModal, row, column) {
	  for (var i = 0; i < taskInfoFromModal.length; i++) {
	    var taskInfo = taskInfoFromModal[i];
	    if (taskInfo.rowIndex === row && taskInfo.columnIndex === column) {
	      return _react2.default.createElement(_TaskLayout2.default, { name: taskInfo.task.name, jobname: taskInfo.task.jobname });
	    }
	  }
	  return '';
	};
	var TableContent = function TableContent(props) {
	  var content = '';
	  return props.employees.map(function (employee, row) {
	    ...
	    return _react2.default.createElement(
	      ...
	      [0, 1, 2, 3, 4].map(function (column) {
	        content = getGridContent(props.taskInfoFromModal, row, column);
	        return _react2.default.createElement(
	          'td',
	          { key: column + '-$-' + row, onClick: function onClick() {
	              return props.handleClick(column, row);
	            } },
	          _react2.default.createElement(
	            'div',
	            { className: 'task-grid' },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Header = function Header(_ref) {
	    var jobDetails = _ref.jobDetails;

	    var header = Object.keys(jobDetails);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TaskGrid = function TaskGrid(_ref) {
	    var _ref$jobDetails = _ref.jobDetails,
	        jobDetails = _ref$jobDetails === undefined ? {} : _ref$jobDetails;

	    var results = [];
	    Object.keys(jobDetails).forEach(function (key) {
	        results.push(_react2.default.createElement(
	            'td',
	            { className: 'task-column', key: key },
	            jobDetails[key].map(function (_ref2) {
	                var jobname = _ref2.jobname,
	                    name = _ref2.name;
	                return _react2.default.createElement(_TaskLayout2.default, { name: name, jobname: jobname, key: name });
	            })
	        ));
	    });
	    return _react2.default.createElement(
	        'tr',
	        { className: 'task-row' },
	        _react2.default.createElement('td', { className: 'task-column' }),
	        results
	    );
	};
	exports.default = TaskGrid;
